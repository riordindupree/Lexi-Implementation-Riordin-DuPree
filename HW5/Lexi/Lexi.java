 ...
 *  - In '#', type in an integer value '5' to run example 5, '4' to run example 4, '3' to run example 3, 
 *    '2' to run example 2. Leaving the space blank, or typing in any other integer value will run example 1. 
 * 
 ...
 * 
 * If option 4 or 5 is selected, System will look for a runtime variable which must be set in the terminal.
...
public class Lexi {
    ...
    private static String increText = "increment +";
    private static String decreText = "decrement -";
    private static String twentyText = "Set Size 20";
    private static String fourteenText = "Set Size 14";
     ...
     * as well as Factory Implementation.
     */
    public static void Example5(Window window){
        // create font manipulation buttons
        Button incrButt = widgetFactory.createButton(window);
        Button decrButt = widgetFactory.createButton(window);
        Button twentyButt = widgetFactory.createButton(window);
        Button fourteenButt = widgetFactory.createButton(window);

        // set properties of buttons
        incrButt.assignCommand(new IncrFontCommand());
        decrButt.assignCommand(new DecrFontCommand());
        twentyButt.assignCommand(new SetFont20Command());
        fourteenButt.assignCommand(new SetFont14Command());

        // set contents of font buttons
        Row rowincr = new Row(increText, window);
        Row rowdecr = new Row(decreText, window);
        Row rowbutt14 = new Row(twentyText, window);
        Row rowbutt20 = new Row(fourteenText, window);

        incrButt.insert(rowincr);
        decrButt.insert(rowdecr);
        twentyButt.insert(rowbutt20);
        fourteenButt.insert(rowbutt14);

        // set contents for row of font buttons
        Row fontRow = new Row(window);
        fontRow.insert(incrButt, 0);
        fontRow.insert(decrButt, 1);
        fontRow.insert(twentyButt, 2);
        fontRow.insert(fourteenButt, 3);
